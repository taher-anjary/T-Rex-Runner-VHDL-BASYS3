...
#set_property PACKAGE_PIN W2 [get_ports {KEY[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {KEY[0]}]
#set_property PACKAGE_PIN U1 [get_ports {KEY[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {KEY[1]}]
#set_property PACKAGE_PIN T1 [get_ports {KEY[2]}]					
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports contact_boolean]					
	set_property IOSTANDARD LVCMOS33 [get_ports contact_boolean]
