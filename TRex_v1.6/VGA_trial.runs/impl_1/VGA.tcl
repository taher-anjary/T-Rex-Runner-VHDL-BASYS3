...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/t.anjary/Desktop/Personal Project/vcurrent/VGA_trial.runs/synth_1/VGA.dcp}}
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file VGA_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file VGA_timing_summary_routed.rpt -warn_on_violation  -rpx VGA_timing_summary_routed.rpx"
